...
[Download Relay 0.3.1 for macOS](https://github.com/justaicode/relay-updates/releases/download/v0.3.1/Relay-0.3.1-macOS.dmg) · [Release notes and all assets](https://github.com/justaicode/relay-updates/releases/tag/v0.3.1)

Requires macOS 14 or later. Supports Intel and Apple Silicon. The app is Developer ID signed and notarized by Apple.

Relay 0.3.1 adds System Settings search: try microphone, camera, Wi-Fi, or keyboard shortcuts in All, then open the matching page.

## Install

1. Download and open **Relay-0.3.1-macOS.dmg**.
